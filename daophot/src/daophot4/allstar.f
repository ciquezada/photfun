...
C     PARAMETER (MAXFRM=67 108 864, PSFMAX=35, NOPT=10)
      PARAMETER (MAXFRM=26 214 400, PSFMAX=35, NOPT=10)
C     PARAMETER (MAXFRM=268 435 456, PSFMAX=101, NOPT=10)
C 
...
C
     ...
     .         '     OS (OUTER SKY RADIUS)'/
      ...
      DATA OMAX  / 49., 8.0, 1.0, 10., 2.0, 100., 100., 100.,
     .           49., 100./
C
...
C
      ...
      PARAMETER (MAXSTR=1 000 000, MAXPSF=407, MAXIT=200, MAXMAX=100,
     .     MAXPAR=6, MAXEXP=10)
C
C Parameters:
C
