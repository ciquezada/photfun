...
C
      ...
      PARAMETER (MAXPSF=407, MAXPAR=6, MAXEXP=10)
C
...
C
C MOFFAT function   BETA = 1.5                 IPSTYP = 2
C
C                            BETA-1
C F = --------------------------------------------------------
...
C
C MOFFAT function  BETA = 2.5                  IPSTYP = 3
C
C                            BETA-1
C F = --------------------------------------------------------
C      Ax * Ay * [1 + (X/Ax)**2 + (Y/Ay)**2 + (XY*Axy)]**BETA
...
C
C MOFFAT function  BETA = 3.5                   IPSTYP = 4
C
C                            BETA-1
C F = --------------------------------------------------------
C      Ax * Ay * [1 + (X/Ax)**2 + (Y/Ay)**2 + (XY*Axy)]**BETA
...
C                                  1
C F = ---------------------------------------------------------------
C     P(1)*P(2)*{1+0.2190137*[(X/P(1))**2+(Y/P(2))**2+(XY*P(3))]**3.5}
C 
C neglecting a constant of proportionality.
C
         ALPHA = 0.2190137
...
C
C Penny function 1                           IPSTYP = 6
C
C Gaussian core plus Lorentzian wings.  The Lorentzian 
...
C
C Penny function 2                      IPSTYP = 7
C Gaussian core plus Lorentzian wings.
